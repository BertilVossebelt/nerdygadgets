...
<h1 style="display:inline; margin-left:300px">Inloggen</h1>
<h1 style="display:inline; margin-left:580px">Registreren</h1> <br>
<div>
    <form method="GET" action="login">
        <label style='margin-left:300px; margin-bottom:0' for="Email">E-Mail:</label>
        ...
        <input style='width:215px; margin-left:300px; margin-bottom:0' type="submit" name="login" value="Log in">
    </form>
    <form method="get" action="registreer">
